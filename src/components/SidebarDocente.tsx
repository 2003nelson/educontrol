            ...
            return (
              <button
                ...
                style={{
                  ...
                  background: selec ? '#f0fdfa' : 'white',
                  border: selec ? '1px solid #99f6e4' : '1px solid transparent',
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
                  <div style={{
                    ...
                    background: selec ? '#0d9488' : '#f1f5f9',
                ...
                {selec && (
                  <svg width="14" height="14" fill="none" stroke="#0d9488" strokeWidth="2.5" viewBox="0 0 24 24">
